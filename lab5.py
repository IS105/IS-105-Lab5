...
def test():
	...
	sf1 = "6C 7C 8C 9C TC".split() # Straight Flush => ['6C', '7C', '8C', '9C', 'TC']
	sf2 = "6D 7D 8D 9D TD".split() # Straight Flush => ['6D', '7D', '8D', '9D', 'TD']	
	...
	fl = "6C, 8C, 10C, QC, KC".split() # Flush 
	assert poker ([fl]) == fl 
	...
	# Hva skjer hvis man har en tom liste som inn-data, dvs. ingen hender? Man vinner
